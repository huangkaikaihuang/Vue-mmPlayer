<template>
  <!--选项-->
  <div class="music-btn">
    <router-link to="/music/playlist" tag="span">点点赞</router-link>
    <router-link to="/music/toplist" tag="span">推荐</router-link>
    <router-link to="/music/search" tag="span">搜索</router-link>
    <router-link to="/music/userlist" tag="span">歌单</router-link>
    <span class="show-960" @click="$emit('onClickLyric')">歌词</span>
    <router-link to="/music/historylist" tag="span">听过</router-link>
  </div>
</template>
